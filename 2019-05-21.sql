...
ip_host bigint not null unique key comment "源ip",
port_host int not null unique key comment "源端口",
ip_obj bigint not null unique key comment "目的ip",
port_obj int not null unique key comment "目的端口",
create_time datetime not null comment "创建时间",
up_down_text varchar(20) comment "上下文信息",
primary key(ip_host,port_host,ip_obj,port_obj)
);

insert into process (ip_host,port_host,ip_obj,port_obj,create_time) values (inet_aton("192.168.133.1"),80,inet_aton("192.168.133.2"),90,"2019-5-21 20:46:30");

select inet_ntoa(ip_host),port_host,inet_ntoa(ip_obj),port_obj,create_time,up_down_text from  process;
