...
DELETE FROM classes WHERE name = '1班'; -- 会失败

DELETE FROM students WHERE name = '小B';
DELETE FROM classes WHERE name = '1班'; -- 会成功
...
--自己练习的goods
create table goods(
goods_id int primary key not null auto_increment comment "商品号",
goods_name varchar(20) unique key not null comment "商品名",
...
customer_id int primary key not null auto_increment comment "顾客号",
name varchar(20) not null comment "姓名",
address varchar(50) comment "地址",
email char(50) comment "邮箱",
sex char(5) comment "性别",
card_id char(20) comment "身份证"
) comment "客户表";

create table purchase(
order_id int primary key not null auto_increment comment "订单号",
customer_id int not null comment "顾客号",
